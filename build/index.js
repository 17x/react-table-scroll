...
var baseIteratee = __webpack_require__(21),
    baseUniq = __webpack_require__(131);
...
var uniqBy = __webpack_require__(65);
...
var orderBy = __webpack_require__(66);
var orderBy_default = /*#__PURE__*/__webpack_require__.n(orderBy);

// EXTERNAL MODULE: ./node_modules/lodash/some.js
var some = __webpack_require__(67);
...
var immutability_helper = __webpack_require__(69);
...
var src_handlePropsData = function handlePropsData() {
  ...
  var copyData = cloneDeep_default()(data);
...
function (_Component) {
  ...
  function ReactTableScroll(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "state", {
      cols: uniqBy_default()(cloneDeep_default()(_this.props.cols), 'valueKey'),
    ...
    _defineProperty(_assertThisInitialized(_this), "handleSelect", function (event, handleCode, idx) {
      ...
      if (handleCode === 'toggle-all') {
        newData = cloneDeep_default()(data); // 已勾选
        // 应用到所有数据行
    ...
    _defineProperty(_assertThisInitialized(_this), "handleSorting", function (col) {
      var currSortCol = cloneDeep_default()(_this.state.currentSorting);
      var newData = cloneDeep_default()(_this.state.data); // 升序降序的高亮状态控制
      ...
      newData = orderBy_default()(newData, currSortCol.key, currSortCol.sort);
    ...
    _defineProperty(_assertThisInitialized(_this), "handleTHeadThMouseMove", function (event) {
      ...
      if (!isNumber_default()(_this.resizingColIndex) || !_this.startPointX || throttling) return;
      throttling = true;
      setTimeout(function () {
        throttling = false;
      }, 100);
      var newCols = cloneDeep_default()(_this.state.cols);
  ...
  _createClass(ReactTableScroll, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (newData && currentData && newData.length === currentData.length) {
        var equals = true;
        newData.map(function (val) {
          equals = some_default()(currentData, val);
        });
        if (equals) return;
      }
